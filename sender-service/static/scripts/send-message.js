...
function sendPushMessage() {
  ...
  const publicElement = 'BDFNZ9P3QrYccT0uwf_p9gzBw_q4UayOzvM8AdmGDWhsBFczni4USFdkHbx01OROINf3fl3qp1z8-WgBIqmEsYs';
  const privateElement = 'bckF92-sZ7C99dQxzz3QTprKnEvIT2WF676Pk9UJXuk';

  const allDataString = JSON.stringify({
    title: titleString,
    text: dataString,
    link: linkToOpenString
  });
